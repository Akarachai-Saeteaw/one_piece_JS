...
export default class Total_Law extends Component {
    render() {
        const {id, ชื่อ, ค่าหัว, ตำแหน่ง, ผลปิศาจ, ความสามารถ, ฉายา, ความเป็นมา, img, pic} = this.props.Name || {};
        ...
        return(
            <div className='swap-on-hover'>
                ...
                <div className='detail'>
                    ...
                    <div className='detail'>
                        <div className='number'>ผลปีศาจ: </div> { ผลปิศาจ }
                    </div>
                    <div className='detail'>
